...
/**
 * Dataset panel skeleton component
 */
const DatasetPanelSkeleton = () => {
    /**
            ...
            <div className="flex flex-wrap items-center gap-3">
                {!isArchived && (
                    <Skeleton className="flex items-center pt-1 pb-1 pl-2 pr-4 font-semibold text-transparent h-9">
                        <Plus className="flex-shrink-0 w-6 h-6 mr-1" /> New dataset
                    </Skeleton>
                )}
...
export default DatasetPanelSkeleton;
