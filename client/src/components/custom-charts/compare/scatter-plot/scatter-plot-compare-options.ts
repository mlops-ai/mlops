...
/**
 * Function for generating the options (configuration) object for a comparasion scatter plot.
 ...
 * @returns Object containing the options for a comparasion scatter plot.
 */
