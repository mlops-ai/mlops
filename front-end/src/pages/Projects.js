...
function Projects(props) {
    ...
    // Stan do przechowywania aktualnej frazy wyszukiwania projektu
    ...
    // Stan zawierający dane aktualnego projektu (np. edytowanego)
    ...
    // Stan zawierający zmienialne dane aktualnego projektu (edytowanego)
            ...
            <section className="projects section content-data">
                ...
                <div className="tab-content pt-2">
                    <div className="tab-pane fade show active" id="active-projects">
                        ...
                        { allProjects && activeProjectsNumber === 0 ?
                        ...
                        { allProjects && activeProjectsNumber !== 0 && activeProjectsFilteredNumber === 0 &&
                            <div className="w-100 d-flex align-items-center justify-content-center text-center no-projects">
                                <div className="d-flex flex-column align-items-center" style={{maxWidth: 50 + "%"}}>
                                    <span className="material-symbols-rounded project-icon" style={{fontSize: 64 + "px"}}>
                                        dashboard
                        ...
                        { allProjects && activeProjectsFilteredNumber > 0 &&
                            <Masonry
                    ...
                    <div className="tab-pane fade show" id="archived-projects">
                        { allProjects && archivedProjectsNumber === 0 ?
                        ...
                        { allProjects && archivedProjectsNumber !== 0 && archivedProjectsFilteredNumber === 0 &&
                            <div className="w-100 d-flex align-items-center justify-content-center text-center no-projects">
                                <div className="d-flex flex-column align-items-center" style={{maxWidth: 50 + "%"}}>
                                    <span className="material-symbols-rounded project-icon" style={{fontSize: 64 + "px"}}>
                                        dashboard
                        ...
                        {allProjects && archivedProjectsFilteredNumber > 0 &&
                                ...
                                <form onSubmit={handleAddProject}>
                                    ...
                                    <div className="mb-3">
                                        <label htmlFor="project-description" className="form-label">
                                            Project description (optional, max 150 characters)
                                        </label>
                ...
                <div className="modal fade" id="delete-project" tabIndex="-1" aria-hidden="true">
                    <div className="modal-dialog modal-dialog-centered">
                        <div className="modal-content">
                            <div className="modal-header">
                                <h5 className="modal-title">Delete Project "{currentProjectData.title}"</h5>
                                <button ref={closeDeleteModalRef} type="button" className="btn-close" data-bs-dismiss="modal"
                                        aria-label="Close"></button>
                            </div>
                            <div className="modal-body">
                                <p>Deleting a project involves deleting all the experiments and models in it permanently. Are you sure you want to continue?</p>
                ...
                <div className="modal fade" id="archive-project" tabIndex="-1" aria-hidden="true">
                    <div className="modal-dialog modal-dialog-centered">
                        <div className="modal-content">
                            <div className="modal-header">
                                <h5 className="modal-title">Archive Project "{currentProjectData.title}"</h5>
                                <button ref={closeArchiveModalRef} type="button" className="btn-close" data-bs-dismiss="modal"
                                        aria-label="Close"></button>
                            </div>
                            <div className="modal-body">
                                <p>Archiving a project will move it to the archive tab. You will not be able to edit or refer to it, but you can restore it at any time. Do you want to continue?</p>
                ...
                <div className="modal fade" id="restore-project" tabIndex="-1" aria-hidden="true">
                    <div className="modal-dialog modal-dialog-centered">
                        <div className="modal-content">
                            <div className="modal-header">
                                <h5 className="modal-title">Restore Project "{currentProjectData.title}"</h5>
                                <button ref={closeRestoreModalRef} type="button" className="btn-close" data-bs-dismiss="modal"
                                        aria-label="Close"></button>
                            </div>
                            <div className="modal-body">
                                <p>Restoring a project will bring it back to the active projects tab. Do you want to continue?</p>
