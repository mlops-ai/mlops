...
const DeleteModelModal = () => {
    ...
    const isModalOpen = isOpen && type === "deleteModel";
    ...
    const handleDeleteModel = async () => {
        ...
        setIsLoading(true);
        await axios
            .delete(`${url}:${port}/monitored-models/${data.model?._id}`)
            .then(() => {
                dataStore.deleteModel(data.model?._id as string);
                onClose();
                createToast({
                    id: "delete-model",
                    message: `Model ${data.model?.model_name} deleted successfully!`,
                    type: "success",
                });
            })
            .catch((error: any) => {
    ...
    const onInteractOutside = (e: any) => {
        if (isLoading || toast.isActive("delete-model")) {
            e.preventDefault();
        }
    };
            ...
            >
                ...
                <div className="flex flex-col px-4 py-2">
                    <div className="flex items-center">
                        ...
                        <div>
                            Deleting a models involves deleting all predictions history of this model.{" "}
